...
const supportSubpaths = new Set([
  'package.json', 'adapter-runtime', 'sequence', 'selection', 'selection-expression', 'metric-index', 'extent-index', 'range', 'index-span', 'grid-control', 'tree', 'result', 'revision', 'interaction',
