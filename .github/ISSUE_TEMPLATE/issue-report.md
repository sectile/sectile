---
name: Issue report
about: Report an issue with evidence for review before implementation.
---
<!-- Template: sectile-issue-report/v1. Remove instructions and replace placeholders.
Read docs/engineering/workflow.md. Submission records an issue report; it does not
...
## Summary
{{Describe one root cause or a clearly bounded issue.}}
