...
export {
  createCalendarMonth as createRangeCalendarMonth,
} from '../calendar.js';

export {
  tryCreateCalendarMonth as tryCreateRangeCalendarMonth,
} from '../calendar.js';
export {
  tryCreateDateRangePickerState as tryCreateRangeCalendarState,
} from './date-range.js';
