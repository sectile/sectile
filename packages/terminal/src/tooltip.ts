...
export function createTooltip(o: TooltipOptions = {}): Result<TooltipConnection> { return createTerminalPopup<TooltipState, TooltipEvent, TooltipCommand>({ controlled: o.open !== undefined, initial: createTooltipState(o.open ?? o.defaultOpen ?? false), reducer: applyTooltipEvent, create: createTooltipState, read: (s) => s.open, close: 'close', interaction: o, onOpenChange: o.onOpenChange, onUpdate: o.onUpdate }); }
