...
class TerminalDateField implements DateFieldConnection {
  readonly options: DateFieldOptions; readonly runtime: SemanticController<DateFieldState, DateFieldEvent, DateFieldCommand>; readonly valueControlled: boolean; readonly inputControlled: boolean;
  public constructor(options: DateFieldOptions, runtime: SemanticController<DateFieldState, DateFieldEvent, DateFieldCommand>, valueControlled: boolean, inputControlled: boolean) { this.options = options; this.runtime = runtime; this.valueControlled = valueControlled; this.inputControlled = inputControlled; }
