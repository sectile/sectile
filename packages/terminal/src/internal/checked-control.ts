import type { Result } from '@sectile/primitives'; import type { MachineUpdate, RevisionSnapshot } from '@sectile/primitives/revision'; import type { TerminalKeyboardInput } from '../keyboard.js';
...
class Impl<State, Event, Command, Value> implements TerminalCheckedControl<State, Event, Value> {
  ...
  public handleEvent(event: Event): boolean { this.#runtime.handle(event); this.#options.onUpdate?.(); return true; }
