...
class TerminalDatePicker implements DatePickerConnection {
  readonly options: DatePickerOptions; readonly runtime: TerminalTemporalController<DatePickerState, DatePickerEvent, DatePickerCommand>; readonly controls: { value: boolean; highlighted: boolean; open: boolean }; readonly granularity: DatePickerValueGranularity;
  public constructor(options: DatePickerOptions, runtime: TerminalTemporalController<DatePickerState, DatePickerEvent, DatePickerCommand>, controls: { value: boolean; highlighted: boolean; open: boolean }, granularity: DatePickerValueGranularity) { this.options = options; this.runtime = runtime; this.controls = controls; this.granularity = granularity; }
