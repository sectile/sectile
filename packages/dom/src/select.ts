...
class DOMSelectConnection<ID extends StableID> implements SelectConnection<ID> {
  ...
  disconnect(): void { this.#layer.disconnect(); this.#position.disconnect(); if (this.#typeaheadTimer !== undefined) clearTimeout(this.#typeaheadTimer); this.#options.trigger.removeEventListener('click', this.#triggerClick); this.#options.trigger.removeEventListener('keydown', this.#keydown); this.#options.popup.removeEventListener('keydown', this.#keydown); this.#options.popup.removeEventListener('click', this.#click); }
