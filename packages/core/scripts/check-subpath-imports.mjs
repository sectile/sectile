...
try {
  ...
  await writeFile(join(directory, 'consumer.mjs'), `
    ...
    import { createVirtualLayoutState } from '@sectile/core/virtual-layout';
    ...
    for (const value of [createSequence, createExtentIndex, createVirtualLayoutState, createRange, createGrid, createTree, unwrap, createListboxState, createCalendarState, createComboboxState, createSliderState, createTreeViewState, createTreeGridModel, createTreeGridModelFromRows, createRevisionSnapshot, createTextEditingState, createFormState]) {
  ...
  await writeFile(join(directory, 'consumer.ts'), `
    ...
    import { createVirtualLayoutState, type VirtualLayoutState } from '@sectile/core/virtual-layout';
    ...
    const virtualLayout: VirtualLayoutState = createVirtualLayoutState(a, extentIndex);
    ...
    void [a, extentIndex, virtualLayout, b, c, d, e, f, g, h, i, j, k, l, m, n, unknownCode];
  `);
