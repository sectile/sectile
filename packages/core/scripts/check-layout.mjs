...
await assertEntries('src', {
  ...
  files: ['accordion.ts', 'alert-dialog.ts', 'calendar.ts', 'carousel.ts', 'checkbox-group.ts', 'checkbox.ts', 'combobox.ts', 'date-field.ts', 'date-picker.ts', 'date-range-picker.ts', 'date-time-field.ts', 'date-time-picker.ts', 'date-time-range-picker.ts', 'dialog.ts', 'disclosure.ts', 'feed.ts', 'index.ts', 'interaction.ts', 'listbox.ts', 'menu-button.ts', 'menu.ts', 'menubar.ts', 'multi-thumb-slider.ts', 'navigation-menu.ts', 'number-field.ts', 'pagination.ts', 'pin-input.ts', 'popover.ts', 'quantity-field.ts', 'radio-group.ts', 'rating.ts', 'result.ts', 'revision.ts', 'select.ts', 'shared.ts', 'slider.ts', 'spin-button.ts', 'stepper.ts', 'switch.ts', 'tabs.ts', 'tags-input.ts', 'text.ts', 'time-field.ts', 'toggle-button.ts', 'toggle-group.ts', 'toolbar.ts', 'tooltip.ts', 'tree-grid.ts', 'tree-view.ts', 'units.ts', 'window-splitter.ts'],
});
