...
await assertEntries('src', {
  ...
  files: ['accordion.ts', 'adapter-runtime.ts', 'alert-dialog.ts', 'calendar.ts', 'carousel.ts', 'cascade-select.ts', 'checkbox-group.ts', 'checkbox.ts', 'collection-window.ts', 'color-picker.ts', 'combobox.ts', 'date-field.ts', 'date-picker.ts', 'date-range-field.ts', 'date-range-picker.ts', 'date-time-field.ts', 'date-time-picker.ts', 'date-time-range-picker.ts', 'dialog.ts', 'disclosure.ts', 'drawer.ts', 'editable.ts', 'feed.ts', 'form.ts', 'index.ts', 'interaction.ts', 'layer-stack.ts', 'listbox.ts', 'menu-button.ts', 'menu.ts', 'menubar.ts', 'month-picker.ts', 'month-range-picker.ts', 'multi-thumb-slider.ts', 'navigation-menu.ts', 'number-field.ts', 'pagination.ts', 'pin-input.ts', 'popover.ts', 'quantity-field.ts', 'radio-group.ts', 'range-calendar.ts', 'rating.ts', 'reorder.ts', 'result.ts', 'revision.ts', 'select.ts', 'shared.ts', 'slider.ts', 'spin-button.ts', 'stepper.ts', 'switch.ts', 'tabs.ts', 'tags-input.ts', 'text.ts', 'time-field.ts', 'time-range-field.ts', 'timer.ts', 'toast.ts', 'toggle-button.ts', 'toggle-group.ts', 'toolbar.ts', 'tooltip.ts', 'tree-grid.ts', 'tree-view.ts', 'units.ts', 'window-splitter.ts', 'year-picker.ts', 'year-range-picker.ts'],
});
