...
await assertEntries('src', {
  ...
  files: ['accordion.ts', 'alert-dialog.ts', 'calendar.ts', 'carousel.ts', 'checkbox-group.ts', 'checkbox.ts', 'combobox.ts', 'dialog.ts', 'disclosure.ts', 'feed.ts', 'index.ts', 'interaction.ts', 'listbox.ts', 'menu-button.ts', 'menu.ts', 'menubar.ts', 'multi-thumb-slider.ts', 'number-field.ts', 'pagination.ts', 'pin-input.ts', 'quantity-field.ts', 'radio-group.ts', 'rating.ts', 'result.ts', 'revision.ts', 'select.ts', 'shared.ts', 'slider.ts', 'spin-button.ts', 'stepper.ts', 'switch.ts', 'tabs.ts', 'tags-input.ts', 'text.ts', 'toggle-button.ts', 'toolbar.ts', 'tooltip.ts', 'tree-grid.ts', 'tree-view.ts', 'units.ts', 'window-splitter.ts'],
});
