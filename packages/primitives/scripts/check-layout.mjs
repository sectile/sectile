...
await assertEntries('src', {
  ...
  files: ['accordion.ts', 'calendar.ts', 'checkbox.ts', 'combobox.ts', 'disclosure.ts', 'index.ts', 'listbox.ts', 'radio-group.ts', 'result.ts', 'revision.ts', 'shared.ts', 'slider.ts', 'switch.ts', 'tabs.ts', 'text.ts', 'toggle-button.ts', 'toolbar.ts', 'tree-grid.ts', 'tree-view.ts', 'window-splitter.ts'],
});
