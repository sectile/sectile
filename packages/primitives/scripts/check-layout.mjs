...
await assertEntries('src', {
  ...
  files: ['accordion.ts', 'alert-dialog.ts', 'calendar.ts', 'carousel.ts', 'checkbox.ts', 'combobox.ts', 'dialog.ts', 'disclosure.ts', 'feed.ts', 'index.ts', 'listbox.ts', 'menu-button.ts', 'menu.ts', 'menubar.ts', 'multi-thumb-slider.ts', 'radio-group.ts', 'result.ts', 'revision.ts', 'shared.ts', 'slider.ts', 'spin-button.ts', 'switch.ts', 'tabs.ts', 'text.ts', 'toggle-button.ts', 'toolbar.ts', 'tooltip.ts', 'tree-grid.ts', 'tree-view.ts', 'window-splitter.ts'],
});
