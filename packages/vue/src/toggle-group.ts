...
export const ToggleGroupRoot = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    return (): VNodeChild => h(Primitive, mergeProps(attrs, getToggleGroupRootAttributes({ orientation: props.orientation, ...(props.label === undefined ? {} : { label: props.label }), disabled: props.disabled, readOnly: props.readonly }) as Record<string, unknown>, {
