...
export type DataTreeGridViewRow = TabularRow;
...
export interface DataTreeGridRootSlotProps { readonly acceptedViewState: DataTreeGridAcceptedViewState; readonly requestState: DataTreeGridRequestState; readonly query: DataTreeGridQuery; readonly rowSelection: DataTreeGridRowSelection; readonly columnState: DataTreeGridColumnState; readonly accessState: DataTreeGridAccessState; readonly expansion: readonly DataTreeGridGroupID[]; readonly cursor: DataTreeGridCursorState; readonly editState: DataTreeGridEditState; readonly rows: readonly DataTreeGridViewRow[] }
export interface DataTreeGridRootExpose { readonly controller: DataTreeGridController; refresh(): void }
export interface DataTreeGridPartProps { readonly as?: PrimitiveAs; readonly asChild?: boolean } export type DataTreeGridHeaderRowProps = DataTreeGridPartProps; export interface DataTreeGridColumnHeaderProps extends DataTreeGridPartProps { readonly headerNodeID: TabularHeaderNodeID }
export interface DataTreeGridSortTriggerProps extends DataTreeGridPartProps { readonly column: string; readonly comparator?: string } export type DataTreeGridFilterControlProps = DataTreeGridPartProps & ({ readonly scope: 'global'; readonly id: string; readonly predicate: string } | { readonly scope: 'column'; readonly column: string; readonly id: string; readonly predicate: string });
export interface DataTreeGridColumnResizeHandleProps extends DataTreeGridPartProps { readonly column: string; readonly minSize?: number; readonly maxSize?: number } export interface DataTreeGridRowProps extends DataTreeGridPartProps { readonly rowID: DataTreeGridRowID | DataTreeGridGroupID }
