...
export {
  ...
  type VirtualListPublicProps,
  type VirtualListSlotProps,
  type VirtualMasonryComponent,
  type VirtualMasonryProps,
  type VirtualMasonryPublicProps,
  ...
  type VirtualSpatialComponent,
  type VirtualSpatialProps,
  type VirtualSpatialPublicProps,
  type VirtualSpatialRectResolver,
  type VirtualSpatialSlotProps,
  type VirtualSpatialZIndexResolver,
  type VirtualizerConnection,
  type VirtualizerContentProps,
