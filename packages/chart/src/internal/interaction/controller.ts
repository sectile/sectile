...
import type { ChartDefinition, ChartDefinitionState } from '../definition/contracts.js';
import { tryCreateChartDefinition, tryReplaceChartDefinition } from '../definition/resolve.js';
import type { ChartPlotInsets } from '../layout/contracts.js';
import { DEFAULT_CHART_PLOT_INSETS } from '../layout/plot.js';
import type { ChartLimits, ChartModel, ChartModelState, ChartPatch } from '../model/contracts.js';
import { tryApplyChartPatch, tryCreateChartModel, tryReplaceChartModel } from '../model/state.js';
import {
...
function sameChartSelection<ID extends StableID>(
  left: import('./state.js').ChartSelection<ID>,
  right: import('./state.js').ChartSelection<ID> | undefined,
): boolean {
