...
import type { ChartDefinitionState, ResolvedChartLayer } from '../definition/contracts.js';
import type {
  ChartAxisLayout,
  ChartPlotInsets,
  ChartPlotLayout,
...
import { tryCreateChartPlotLayout } from '../layout/plot.js';
...
} from '../model/layer-owner.js';
import { type ChartModelData, getChartModelData, type PackedChartLayer } from '../model/store.js';
...
function projectAggregateCells(
  layerIndex: number,
  entries: readonly import('../model/layer-owner.js').PackedAggregateSelectionEntry[],
  xScale: ChartScale<number>,
  yScale: ChartScale<number>,
  transform: ChartViewTransform,
