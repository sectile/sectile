...
test('terminal playground exposes disabled cases for every facade and read-only cases where supported', () => {
  const readOnlyIDs = new Set([
    ...
    'checkbox', 'spin-button', 'number-field', 'quantity-field', 'date-field', 'time-field',
