...
const copy = computed(() => isKorean.value ? {
  ...
  form: '폼 조정',
  formRole: '필드 경로, 이슈, 검증, 제출과 초기화 상태를 계산합니다.',
  formExamples: ['경로', '검증', '제출', '초기화'],
  temporal: '날짜와 시각',
  ...
  formRole: 'Computes field paths, issues, validation, submission, and reset state.',
  formExamples: ['paths', 'validation', 'submission', 'reset'],
