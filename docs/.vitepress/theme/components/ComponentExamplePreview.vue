...
const AccordionCase = defineAsyncComponent(() => import('./AccordionCase.vue'));
const CascadeListCase = defineAsyncComponent(() => import('./CascadeListCase.vue'));
const CascadeSelectCase = defineAsyncComponent(() => import('./CascadeSelectCase.vue'));
const CatalogCase = defineAsyncComponent(() => import('./CatalogCase.vue'));
const CheckedControlCase = defineAsyncComponent(() => import('./CheckedControlCase.vue'));
const ColorPickerCase = defineAsyncComponent(() => import('./ColorPickerCase.vue'));
const DateRangeFieldCase = defineAsyncComponent(() => import('./DateRangeFieldCase.vue'));
...
const MultiThumbSliderCase = defineAsyncComponent(() => import('./MultiThumbSliderCase.vue'));
const NativeFieldCase = defineAsyncComponent(() => import('./NativeFieldCase.vue'));
const PaginationCase = defineAsyncComponent(() => import('./PaginationCase.vue'));
const PopoverCase = defineAsyncComponent(() => import('./PopoverCase.vue'));
const RadioGroupCase = defineAsyncComponent(() => import('./RadioGroupCase.vue'));
const SliderCase = defineAsyncComponent(() => import('./SliderCase.vue'));
const SpinButtonCase = defineAsyncComponent(() => import('./SpinButtonCase.vue'));
const TabsCase = defineAsyncComponent(() => import('./TabsCase.vue'));
const TextCase = defineAsyncComponent(() => import('./TextCase.vue'));
const TimeRangeFieldCase = defineAsyncComponent(() => import('./TimeRangeFieldCase.vue'));
const TimerCase = defineAsyncComponent(() => import('./TimerCase.vue'));
const ToastCase = defineAsyncComponent(() => import('./ToastCase.vue'));
const ToggleGroupCase = defineAsyncComponent(() => import('./ToggleGroupCase.vue'));
const TreeGridCase = defineAsyncComponent(() => import('./TreeGridCase.vue'));
const TreeViewCase = defineAsyncComponent(() => import('./TreeViewCase.vue'));
const WindowSplitterCase = defineAsyncComponent(() => import('./WindowSplitterCase.vue'));
