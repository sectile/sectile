...
Build accessible forms from native controls and Sectile components with shared validation, submission, and reset behavior.
...
| <kbd>Enter</kbd> | Submit from an eligible native control and validate the form. |
