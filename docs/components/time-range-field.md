...
```ts [Core]
import * as timeRangeField from '@sectile/core/time-range-field'
```

```ts [DOM]
import * as timeRangeField from '@sectile/dom/time-range-field'
```

```ts [Terminal]
import * as timeRangeField from '@sectile/terminal/time-range-field'
```

```ts [Vue]
import * as timeRangeField from '@sectile/vue/time-range-field'
```
