...
const koCommon = Object.freeze({
  ...
  readonly: '값을 확인할 수 있지만 바꿀 수 없게 할지 여부입니다.',
  ...
  asChild: '래퍼를 만들지 않고 하나의 자식 요소에 파트 속성을 합칠지 여부입니다.',
...
const koProps = Object.freeze({
  ...
  autoplay: '직접 조작하지 않아도 캐러셀이 자동으로 넘어갈지 여부입니다.',
  ...
  countdown: '경과 시간을 재지 않고 남은 시간을 셀지 여부입니다.',
  defaultDisplayUnit: '외부에서 단위를 제어하지 않을 때 처음 사용할 표시 단위입니다.',
  ...
  disabledValues: '화면에는 표시하지만 선택할 수 없게 할 값입니다.',
  ...
  placeholder: '아직 값이 없을 때 표시할 안내 문자열입니다.',
  ...
  referenceDate: '달력에 선택값이나 강조값이 없을 때 사용할 시간대 없는 기준 날짜입니다.',
...
const koSlots = Object.freeze({
  ...
  dismiss: '알림 하나를 닫는 함수입니다.', dismissAll: '모든 알림을 닫는 함수입니다.', displayUnit: '현재 표시 단위입니다.', draft: '아직 확정하지 않은 입력 문자열입니다.',
