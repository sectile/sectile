...
const enProps = Object.freeze({
  ...
  equals: 'Returns whether two selected snapshots are equivalent.',
  ...
  onSubmit: 'Handles a validated native submission and may report success, a submission failure, or server issues.',
  mapSubmitError: 'Maps a thrown or rejected submission error to a safe application-facing failure.',
  ...
  select: 'Selects the form or field state exposed to the slot.',
  ...
  tracking: 'Update strategy used while anchored content is open.',
...
const koProps = Object.freeze({
  ...
  equals: '선택한 두 상태 스냅샷이 같은지 판정하는 함수입니다.',
  ...
  onSubmit: '검증을 통과한 네이티브 제출을 처리하고 성공, 제출 failure 또는 서버 이슈를 반환하는 함수입니다.',
  mapSubmitError: '제출 중 throw 또는 reject된 오류를 사용자에게 노출해도 되는 failure로 변환하는 함수입니다.',
  ...
  select: '슬롯에 노출할 폼 또는 필드 상태를 선택하는 함수입니다.',
  ...
  tracking: '기준 요소에 연결된 콘텐츠가 열린 동안 위치를 갱신할 방식입니다.',
...
const enSlots = Object.freeze({
  ...
  isIndeterminate: 'Whether only part of a grouped value is selected.', issues: 'Current canonical validation issues.', item: 'Current pagination item.',
  ...
  clearIssues: 'Clears validation issues for this field.', removeIssue: 'Removes one field issue by ID.', setMeta: 'Updates mutable metadata for this field.', upsertIssue: 'Adds or replaces one field issue.',
  ...
  state: 'Complete current form state.', status: 'Current lifecycle status.', submitCount: 'Number of submission attempts derived from submission.count.',
  validation: 'Current validation lifecycle snapshot.', submission: 'Current submission lifecycle snapshot.',
  relatedIssues: 'Issues owned elsewhere that also make this field invalid.', serverIssues: 'Current canonical server issues.', firstIssue: 'First canonical issue, or null.',
  submissionStatus: 'Current submission lifecycle.', submitting: 'Whether form submission is currently in progress.', canSubmit: 'Whether the form is valid and not currently submitting.', validationStatus: 'Current validation lifecycle.',
...
const koSlots = Object.freeze({
  ...
  isIndeterminate: '묶음 값의 일부만 선택됐는지 여부입니다.', issues: '현재 canonical 검증 이슈입니다.', item: '현재 페이지 항목입니다.', items: '현재 계산된 항목 컬렉션입니다.',
  ...
  clearIssues: '현재 필드의 검증 이슈를 비우는 함수입니다.', removeIssue: 'ID로 필드 이슈 하나를 제거하는 함수입니다.', setMeta: '현재 필드의 수정 가능한 메타 상태를 갱신하는 함수입니다.', upsertIssue: '필드 이슈 하나를 추가하거나 교체하는 함수입니다.',
  ...
  state: '현재 전체 폼 상태입니다.', status: '현재 생명주기 상태입니다.', submitCount: 'submission.count에서 계산한 제출 시도 횟수입니다.', submitFailed: '식별한 제출을 실패로 기록하는 함수입니다.',
  validation: '현재 검증 생명주기 스냅샷입니다.', submission: '현재 제출 생명주기 스냅샷입니다.',
  relatedIssues: '다른 필드가 소유하지만 현재 필드도 무효로 만드는 이슈입니다.', serverIssues: '현재 canonical 서버 이슈입니다.', firstIssue: '첫 canonical 이슈이며 없으면 null입니다.',
  submissionStatus: '현재 제출 생명주기입니다.', submitting: '폼 제출이 진행 중인지 여부입니다.', canSubmit: '폼이 유효하고 제출 중이 아닌지 여부입니다.', validationStatus: '현재 검증 생명주기입니다.',
