...
const accessibilityByComponent = Object.freeze({
  ...
  'date-time-range-picker': ['Four labeled endpoint inputs and the calendar grid expose the range without collapsing its start and end semantics.', '네 개의 양 끝 입력과 달력 격자가 시작·종료 의미를 합치지 않고 범위를 노출합니다.'],
