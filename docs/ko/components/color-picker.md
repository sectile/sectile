...
<p>색상값에 투명도를 포함할 수 있는지 여부입니다.</p>
</dd>
</div>
<div class="component-api-definition">
<dt><code>alphaStep</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>number</code></span><span><span class="component-api-definition__label">기본값</span><code>17</code></span></div>
<p>투명도 채널을 바꿀 때 적용할 증감 간격입니다.</p>
</dd>
</div>
<div class="component-api-definition">
<dt><code>as</code></dt>
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorFormat</code></span><span><span class="component-api-definition__label">기본값</span><code>'hex'</code></span></div>
<p>컴포넌트가 관리하는 초기 색상 형식입니다.</p>
</dd>
</div>
<div class="component-api-definition">
<dt><code>defaultValue</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>string</code></span><span><span class="component-api-definition__label">기본값</span><code>'#5b6df6'</code></span></div>
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorFormat</code></span><span><span class="component-api-definition__label">기본값</span><code>undefined</code></span></div>
<p>외부에서 제어하는 색상 형식입니다.</p>
</dd>
</div>
<div class="component-api-definition">
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorChannel</code></span><span><span class="component-api-definition__label">기본값</span>필수</span></div>
<p>이 입력이 편집할 색상 채널입니다.</p>
</dd>
</div>
</dl>
...
<dt><code>format</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorFormat</code></span><span><span class="component-api-definition__label">기본값</span>필수</span></div>
<p>외부에서 제어하는 색상 형식입니다.</p>
</dd>
</div>
</dl>
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorCoordinate</code></span><span><span class="component-api-definition__label">기본값</span>필수</span></div>
<p>선택한 색상 모델에서 편집할 좌표입니다.</p>
</dd>
</div>
<div class="component-api-definition">
<dt><code>format</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorModel</code></span><span><span class="component-api-definition__label">기본값</span>필수</span></div>
<p>외부에서 제어하는 색상 형식입니다.</p>
</dd>
</div>
</dl>
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorAreaValue</code></span></div>
<p>현재 2차원 색상 영역 상태입니다.</p>
</dd>
</div>
<div class="component-api-definition">
<dt><code>channel</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorChannel</code></span></div>
<p>현재 색상 채널입니다.</p>
</dd>
</div>
<div class="component-api-definition">
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>readonly ColorCoordinateValue[]</code></span></div>
<p>현재 색상 모델의 좌표입니다.</p>
</dd>
</div>
<div class="component-api-definition">
...
<dt><code>format</code></dt>
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorFormat</code></span></div>
<p>현재 색상 형식입니다.</p>
</dd>
</div>
<div class="component-api-definition">
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">타입</span><code>ColorValue</code></span></div>
...
<dd>
<div class="component-api-definition__metadata"><span><span class="component-api-definition__label">페이로드</span><code>ColorFormat</code></span></div>
<p>새 색상 형식을 요청할 때 발생합니다.</p>
</dd>
</div>
<div class="component-api-definition">
