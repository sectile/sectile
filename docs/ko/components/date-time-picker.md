...
날짜·시간 선택기는 시간대와 무관한 날짜·시간 값과 달력 이동을 다룹니다.
...
| 패키지 | 가져오기 경로 | 상태 |
| --- | --- | --- |
| 코어 | `@sectile/core/date-time-picker` | 배포됨 |
| 브라우저 | `@sectile/dom/date-time-picker` | 배포됨 |
| 터미널 | `@sectile/terminal/date-time-picker` | 배포됨 |
| Vue | `@sectile/vue/date-time-picker` | 개발 중 |
