...
| 패키지 | 가져오기 경로 | 상태 |
| --- | --- | --- |
| 코어 | `@sectile/core/toggle-button` | 배포됨 |
| 브라우저 | `@sectile/dom/toggle-button` | 배포됨 |
| 터미널 | `@sectile/terminal/toggle-button` | 배포됨 |
| Vue | `@sectile/vue/toggle-button` | 개발 중 |
