---
title: Year Picker API
description: 페이지로 나뉜 연도 격자에서 해 하나를 고릅니다.
---
...
[Year Picker 사용 예시로 돌아가기](/ko/components/year-picker)

## Vue API

Vue 패키지: `@sectile/vue/temporal/year-picker`
...
<ul class="component-api-list">
  ...
  <li><code class="component-api-token">YearPickerAnchor</code></li>
