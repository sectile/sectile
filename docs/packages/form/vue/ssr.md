...
description: Keep server-rendered Vue forms stable across hydration, controlled values, and Teleports.
---
...
See [Vue forms](./) for the basic composition and [submission, reset, and reinitialization](./submission) for controlled-value ownership.
