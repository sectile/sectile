---
title: Decisions
description: Accepted public-boundary, coordinate, and migration decisions.
---

# Decisions

Accepted decisions are derived from Sectile ownership, invariants, and cost contracts rather than the previous repository layout.
...
- [DOM range-calendar consumer-bundle baseline ratchet](dom-range-calendar-bundle-baseline-ratchet.md) advances the focused Temporal fixture reference to the already-published `@sectile/dom@0.18.0` artifact.
